...
This package was developed for educational purposes using three-hourly weather data recorded by the Department of Meteorology, Sri Lanka (https://meteo.gov.lk/
)
