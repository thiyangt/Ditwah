...
The goal of the Dithwa project, which hit Sri Lanka on November 28, 2025, is to provide data, monitoring, and early warning capabilities.
...
ditwah_3hr_weather_data |>
  ...
  labs(x = "Rainfall (mm)", y = "Station Name", title = "Rainfall by Station") +
  theme_minimal() +
